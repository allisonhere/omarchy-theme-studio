...
REPO="https://github.com/allisonhere/omarchy-theme-studio"
BIN="omarchy-theme-studio"
INSTALL_DIR="${INSTALL_DIR:-$HOME/.local/bin}"
LATEST_RELEASE="https://github.com/allisonhere/omarchy-theme-studio/releases/latest/download"
